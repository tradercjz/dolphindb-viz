...
const EachPrePanel: React.FC<{ params: any; setParams: (p: any) => void }> = ({ params, setParams }) => {
  return (
...
export const EachPrePlugin: Plugin = {
  id: 'eachPre',
  name: 'Each Pre',
  description: 'Visualize eachPre function',
  SceneComponent: EachPreScene,
  ParameterPanelComponent: EachPrePanel,
  defaultParams: {
    func: 'sub',
    boundaryVal: 0
  }
